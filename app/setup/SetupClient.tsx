...
export default function SetupClient() {
  ...
  const testDb = async () => {
    ...
    try {
      ...
      setError(e instanceof Error ? e.message : 'Setup request failed')
    } finally {
      setLoading(false)
    }
  }
  ...
  const pushSchema = async () => {
    ...
    try {
      ...
      setError(e instanceof Error ? e.message : 'Schema push failed')
    } finally {
      setLoading(false)
    }
  }
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  For Supabase: find this under Project Settings, Database, then Connection String (Transaction mode).
                </p>
              </div>
